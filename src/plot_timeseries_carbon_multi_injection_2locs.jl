...
mkpath(outputdir)
outputfile = joinpath(outputdir, "injected_tracer_timeseries_v2_2locs.png")
@info "Saving injection location as image file:\n  $(outputfile)"
save(outputfile, fig)
outputfile = joinpath(outputdir, "injected_tracer_timeseries_v2_2locs.pdf")
@info "Saving injection location as image file:\n  $(outputfile)"
save(outputfile, fig)
