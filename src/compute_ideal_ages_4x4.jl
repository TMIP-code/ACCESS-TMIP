...
# (; edge_length_2D, distance_to_edge_2D) = modelgrid

# fig = Figure(size=(1200, 500));
# for (i, dir) in enumerate((:east, :west, :north, :south))
#     ax = Axis(fig[1,i])
#     heatmap!(ax, edge_length_2D[dir])
#     ax = Axis(fig[2,i])
#     heatmap!(ax, distance_to_edge_2D[dir])
...
# outputfile = joinpath(inputdir, "distances_bug.png")
# @info "Saving ideal mean age as image file:\n  $(outputfile)"
# save(outputfile, fig)