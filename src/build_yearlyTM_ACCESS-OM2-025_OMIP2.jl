...
# script options
inputdir = "/scratch/y99/TMIP/data/ACCESS-OM2-025/025deg_jra55_iaf_omip2_cycle6/Jan1960-Dec1979"
...
κVdeep = 3.0e-5 # m^2/s
κVML = 1.0      # m^2/s
κH = 300.0 / 4  # m^2/s (÷4 as simple grid scaling, from 1° to 0.25°)
...
save(
    ...
    Dict(
        "T" => T,
        "note" => """Test 0.25-degree transport matrix built from averaging
