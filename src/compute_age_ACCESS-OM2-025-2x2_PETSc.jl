...
agecube = DimensionalData.rebuild(volcello_ds["volcello"];
    ...
    dims = dims(volcello),
    metadata = Dict(
        "description" => "steady-state mean age with coarsening 2x2",
        "model" => model,
...
# Save to netCDF file
outputfile = joinpath(inputdir, "steady_age_$(κVdeep_str)_$(κH_str)_$(κVML_str)_OM2-025-2x2$(parentκH_str2)_PETSc.nc")
