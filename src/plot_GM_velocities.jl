...
u1 = GMmasstransport_fromMattChamberlain.uGM[wet3D] * 1.0e-9
u2 = umo_GM[wet3D] * 1.0e-9
u3 = GMmasstransport_fromACCESSESM15.ϕGMᵢmean[wet3D] * 1.0e-9
v1 = GMmasstransport_fromMattChamberlain.vGM[wet3D] * 1.0e-9
v2 = vmo_GM[wet3D] * 1.0e-9
v3 = GMmasstransport_fromACCESSESM15.ϕGMⱼmean[wet3D] * 1.0e-9
