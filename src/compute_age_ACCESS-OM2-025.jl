# qsub -I -P y99 -q express -l mem=190GB -l storage=scratch/gh0+scratch/y99+scratch/p66 -l walltime=01:00:00 -l ncpus=48
# qsub -I -P y99 -q normal -l mem=190GB -l storage=scratch/gh0+scratch/y99+scratch/p66 -l walltime=02:00:00 -l ncpus=48
# qsub -I -P y99 -q hugemem -l mem=1470GB -l storage=scratch/gh0+scratch/y99+scratch/p66 -l walltime=02:00:00 -l ncpus=48
