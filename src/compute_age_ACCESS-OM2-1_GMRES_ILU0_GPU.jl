...
workspace = GmresWorkspace(opA, b_gpu)

gmres!(workspace, opA, b_gpu, N = P, ldiv = true, rtol = 1.0e-10, atol = 0.0, verbose = 1)
# @show stats
...
# Save to netCDF file
outputfile = joinpath(inputdir, "steady_age_$(κVdeep_str)_$(κH_str)_$(κVML_str)_GMRES_ILU0_GPU.nc")
