...
# Coarsen 2x2 North of 40°S (so effectively 0.1° -> 0.2°)
@info "coarsening grid 2x2 north of 40°S"
SOmask = lat.data .< -40
...
# Save to netCDF file
outputfile = joinpath(inputdir, "steady_age_$(κVdeep_str)_$(κH_str)_$(κVML_str)_2x240S.nc")
