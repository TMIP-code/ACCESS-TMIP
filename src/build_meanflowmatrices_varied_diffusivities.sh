...
# for member in r{20..20}i1p1f1; do
    ...
    julia src/build_meanflowmatrices_varied_diffusivities.jl $experiment $member $time_window &> output/build_meanflowmatrices_varied_diffusivities.$experiment.$member.$time_window.$PBS_JOBID.out
done
