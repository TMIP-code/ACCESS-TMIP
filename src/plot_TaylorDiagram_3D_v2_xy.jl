# qsub -I -P xv83 -l mem=64GB -l storage=scratch/gh0+scratch/xv83 -l walltime=00:30:00 -l ncpus=12
...
# Yes, I fucked up with the name... Printed a boolean instead of the string...
function parse_κs(f)
